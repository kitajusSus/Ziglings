// the problem is that I don't know how to stop the loop when the tail is null or undefined
//
// Exercise:
...
const Elephant = struct {
    ...
    //* ten element pokazuje ze z definicji moze tu być cokolwiek, numer, string, czy inne struktuyry itd.
    visited: bool = false, // klasyka, odwiedzony czy nie,
};
...
fn linkElephants(e1: ?*Elephant, e2: ?*Elephant) void {
    // If either elephant is missing, stop the program.
    e1.?.*.tail = e2;
}
